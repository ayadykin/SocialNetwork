...
public class InitTest {
    ...
    protected User user10 = new User(new Profile("user10", "user10", "Dnepr", "Ukraine", Locale.US));
    protected User user20 = new User(new Profile("user20", "user20", "Lviv", "Ukraine", Locale.US));
    protected User user30 = new User(new Profile("Roma", "D", "Kiev", "Ukraine", Locale.US));

...
public class InitTest {
    ...
    protected Account account10 = new Account("user10", "user1", Role.ROLE_USER, user10);
    protected Account account20 = new Account("user20", "user2", Role.ROLE_USER, user20);
    protected Account account30 = new Account("user30", "user2", Role.ROLE_USER, user30);
